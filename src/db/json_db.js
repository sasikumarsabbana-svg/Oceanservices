...
function seedDatabase() {
  ...
  if (!fs.existsSync(documentsFile)) {
    ...
    const docs = [
      ...
      { id: 2, title: 'Coral Bleaching Alert Sea Temperature Video Guide', description: 'Video walkthrough explaining Sea Surface Temperature (SST) satellite anomalies, thermal stress hotspots, and coral bleaching risk alerts.', file_path: 'https://www.youtube.com/watch?v=uK731B6J8sA', type: 'VIDEO', service_id: 7, category_id: 3, tags: 'coral, bleaching, sea temperature, sst, tutorial', uploaded_by: 1, created_at: new Date().toISOString() },
      { id: 3, title: 'Oil Spill Hydrodynamic Current & Drift Trajectory Guide', description: 'Technical video guide on modeling marine oil chemical drift, hydrodynamic current trajectories, and containment SOPs.', file_path: 'https://www.youtube.com/watch?v=wP1p_gB7yoc', type: 'VIDEO', service_id: 5, category_id: 3, tags: 'oil spill, detection, drift, response, video guide', uploaded_by: 1, created_at: new Date().toISOString() },
      { id: 4, title: 'Tsunami Early Warning System & Buoy Network Guide', description: 'Operational video on deep sea tsunami buoys, seismic detection networks, and coastal inundation warning protocols.', file_path: 'https://www.youtube.com/watch?v=2v-Z3u80x6k', type: 'VIDEO', service_id: 3, category_id: 3, tags: 'tsunami, early warning, buoy, seismic, advisory', uploaded_by: 1, created_at: new Date().toISOString() },
      { id: 5, title: 'Numeric Wave Forecasting & Marine Swell Model Guide', description: 'Video manual covering sea boundary wave conditions, swell periods, wave heights, and marine forecast models.', file_path: 'https://www.youtube.com/watch?v=w2P8wYt7Qo0', type: 'VIDEO', service_id: 1, category_id: 3, tags: 'wave, swell, forecasting, hydrodynamic, oceanography', uploaded_by: 1, created_at: new Date().toISOString() }
    ];
